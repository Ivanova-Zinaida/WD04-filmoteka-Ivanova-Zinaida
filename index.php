	  ...
	  <?php } ?>
	    ...
	    <div class="card mb-20">
			<div class="card__header">
				...
				<div><a href="edit.php?id=<?=$films[$key]['id']?>" class="button button--edit">Редактировать</a>
				<a href="?action=delete&id=<?=$films[$key]['id']?>" class="button button--delete">Удалить</a></div>
